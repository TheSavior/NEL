...
import com.cse454.warmup.sf.SFEntity.SingleAnswer;
import com.cse454.warmup.sf.eval.SFScore;
import com.cse454.warmup.sf.filler.Filler;
import com.cse454.warmup.sf.filler.regex.RegexPerDateOfBirthFiller;
import com.cse454.warmup.sf.retriever.ProcessedCorpus;
import com.cse454.warmup.util.FileUtil;
...
public class Assignment1 {
	public static void main(String[] args) throws Exception {
		...
		if (run) {
			// read the queries
			com.cse454.warmup.sf.query.QueryReader queryReader = new com.cse454.warmup.sf.query.QueryReader();
